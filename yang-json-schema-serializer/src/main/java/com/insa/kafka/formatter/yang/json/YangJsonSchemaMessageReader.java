...
import com.insa.kafka.serializers.yang.json.AbstractKafkaYangSchemaSerializer;
import com.insa.kafka.serializers.yang.json.KafkaYangSchemaSerializerConfig;
...
public class YangJsonSchemaMessageReader extends SchemaMessageReader<JsonNode>
  ...
  static class YangJsonSchemaSerializer extends AbstractKafkaYangSchemaSerializer<JsonNode>
    ...
    public void configure(Map<String, ?> configs, boolean isKey) {
      if (!configs.containsKey(KafkaYangSchemaSerializerConfig.YANG_JSON_FAIL_INVALID_SCHEMA)) {
        ((Map<String, Object>) configs).put(
            KafkaYangSchemaSerializerConfig.YANG_JSON_FAIL_INVALID_SCHEMA, "true");
      }
      configure(new KafkaYangSchemaSerializerConfig(configs));
    }
